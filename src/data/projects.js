    ...
    technicalDecisions: [
      {
        ...
        explain: `Backend y frontend se organizan por feature (productos, garantías, reportes...) y no por tipo de archivo.
      ...
      },
      {
        ...
        explain: `El acceso a datos se escribe en SQL directo sobre MySQL 8 con sustitución por %s, nunca interpolando strings.
      ...
      },
      {
        ...
        explain: `Toda escritura sigue el mismo contrato: el servicio abre la conexión, confirma al terminar, revierte ante cualquier excepción y cierra en el finally.
      ...
      },
      {
        ...
        explain: `Los tokens viajan en cookies HttpOnly, así que ningún JavaScript de la página puede leerlos y un XSS no se lleva la sesión.
      ...
      },
      {
        ...
        explain: `Los roles (Administrador, Almacén, Técnico) no se resuelven ocultando botones en la interfaz: un middleware valida el rol contra el token en cada petición.
      ...
      },
      {
        ...
        explain: `Los envíos de bienvenida, recuperación de contraseña y sugerencias se encolan en Redis y los procesa un worker de Celery con reintentos automáticos.
      ...
      },
      {
        ...
        explain: `El mismo Redis que actúa de broker sostiene el limitador por IP (login mucho más restrictivo que los listados) y la caché de consultas frecuentes, con invalidación explícita al escribir.
      ...
      },
      {
        ...
        explain: `Un plan de JMeter ejercita los endpoints críticos bajo concurrencia para medir cómo responde la API cuando varios usuarios trabajan a la vez.
    ...
    technicalDecisions: [
      {
        ...
        explain: `Un mismo despliegue atiende a varios parqueaderos y el identificador de tenant se lee siempre del JWT, jamás del body, la ruta o el query string.
      ...
      },
      {
        ...
        explain: `El chatbot no improvisa, cada consulta recupera contexto del parqueadero desde una base vectorial (Qdrant con embeddings locales) y el modelo solo puede actuar mediante un registro de herramientas con esquema declarado y rol requerido.
      ...
      },
      {
        ...
        explain: `Antes de llegar al modelo, un clasificador descarta intentos de inyección de prompt. El prompt del sistema restringe el dominio, las herramientas destructivas exigen una confirmación explícita y el aislamiento por tenant se aplica igual que en el resto del sistema.
      ...
      },
      {
        ...
        explain: `El historial vive por parqueadero y usuario con tope de mensajes y expiración automática, saneando secuencias incompletas de llamadas a herramientas antes de reenviarlas al modelo.
      ...
      },
      {
        ...
        explain: `El servidor emite los tokens como cookies HttpOnly, el cliente envía las credenciales en cada petición y solo renueva cuando recibe un 401.
      ...
      },
      {
        ...
        explain: `Plazas tipadas por vehículo, tarifas por tipo, redondeo del cobro y liberación de la plaza al pagar viven en transacciones del servidor.
      ...
      },
      {
        ...
        explain: `Los correos se encolan con Celery y se envían en segundo plano con reintentos, mientras el mismo Redis sostiene el rate limiting por endpoint.
      ...
      },
      {
        ...
        explain: `La suite de pytest cubre las funciones donde un error es silencioso y caro: normalización de placas, redondeo del cobro, manejo de fechas y períodos, y validación de entradas.
